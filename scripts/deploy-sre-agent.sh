...
run_v2_flow() {
  ...
  (
    ...
    AZURE_RESOURCE_GROUP="$APP_RG" \
    GRUBIFY_RESOURCE_TOKEN="$RESOURCE_TOKEN" \
    ...
    SRE_AGENT_RESOURCE_GROUP="$SRE_RG" \
    SRE_AGENT_ENDPOINT="$AGENT_ENDPOINT" \
    ENABLE_GITHUB_AUTH_CONNECTOR="${ENABLE_GITHUB_AUTH_CONNECTOR:-true}" \
    GITHUB_AUTH_CONNECTOR_TYPE="${GITHUB_AUTH_CONNECTOR_TYPE:-oauth}" \
